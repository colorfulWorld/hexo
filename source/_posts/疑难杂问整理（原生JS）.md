...
如果服务器发现这个文件改变了那么你肯定不能再用以前浏览器的缓存了，那就返回个 200 并且带上新的文件。
...
4. 操作系统间根域名发送至 LDNS（本地域名服务器），首先查找自己的缓存若是失败：
   1. 向根域名服务器发起请求，此处根域名服务器返回 com 域的 sing 机域名服务器地址。
   2. LDNS 向 com 域的顶级域名服务器发起请求，得到 www.baidu.com 的地址。
   3. LONS 向 baidu.com 域名服务器发起请求，得到 www.baidu.com 的 IP 地址。
